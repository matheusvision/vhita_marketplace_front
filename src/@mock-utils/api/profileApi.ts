...
const profileApi = [
	 ...
	 */
	http.get('/api/mock/profile/albums', async ({ params, request }) => {
	 ...
	 */
	http.get('/api/mock/profile/media-items', async ({ params, request }) => {
	 ...
	 */
	http.get('/api/mock/profile/activities', async ({ params, request }) => {
	 ...
	 */
	http.get('/api/mock/profile/posts', async ({ params, request }) => {
	 ...
	 */
	http.get('/api/mock/profile/about', async ({ params, request }) => {
