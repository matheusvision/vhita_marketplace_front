...
const userSlice = createSlice({
	...
	extraReducers: {
		[updateUserSettings.fulfilled]: (state: any, action: any) => action.payload,
		[updateUserShortcuts.fulfilled]: (state: any, action: any) => action.payload,
		[setUser.fulfilled]: (state: any, action: any) => action.payload
	}
});
