...
function ModernReversedUnlockSessionPage() {
	...
	return (
		<div className="flex min-w-0 flex-auto flex-col items-center sm:justify-center md:p-32">
			<Paper className="sm:min-h-auto rounded-0 flex min-h-full w-full overflow-hidden sm:w-auto sm:rounded-2xl sm:shadow md:w-full md:max-w-6xl">
				<Box
				...
				<div className="rtl:border-r-1 ltr:border-l-1 w-full px-16 py-32 sm:w-auto sm:p-48 md:p-64">
