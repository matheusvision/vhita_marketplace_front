import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Accordion</Typography>
...
<Typography className="mb-40" component="div">An accordion is a lightweight container that may either be used standalone, or be connected to a larger surface, such as a card.</Typography>
...
:::</Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Basic accordion</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Controlled accordion</Typography>
<Typography className="mb-40" component="div">The Accordion component can be controlled or uncontrolled.</Typography>
...
<Typography className="mb-40" component="div">The content of Accordions is mounted by default even if the accordion is not expanded.
...
<Typography className="mb-40" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/accordion/">https://www.w3.org/WAI/ARIA/apg/patterns/accordion/</a>)</Typography>
<Typography className="mb-40" component="div">For optimal accessibility we recommend setting <code>{`id`}</code> and <code>{`aria-controls`}</code> on the
