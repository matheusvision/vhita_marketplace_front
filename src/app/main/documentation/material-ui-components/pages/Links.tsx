import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Links</Typography>
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Basic links</Typography>
<Typography className="mb-40" component="div">The Link component is built on top of the <a href="/material-ui/api/typography/">Typography</a> component, meaning that you can use its props.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="mb-40" component="div">However, the Link component has some different default props than the Typography component:</Typography>
<ul>
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Underline</Typography>
<Typography className="mb-40" component="div">The <code>{`underline`}</code> prop can be used to set the underline behavior. The default is <code>{`always`}</code>.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Security</Typography>
<Typography className="mb-40" component="div">When you use <code>{`target="_blank"`}</code> with Links, it is <a href="https://developers.google.com/web/tools/lighthouse/audits/noopener">recommended</a> to always set <code>{`rel="noopener"`}</code> or <code>{`rel="noreferrer"`}</code> when linking to third party content.</Typography>
<ul>
...
<Typography className="mb-40" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/link/">https://www.w3.org/WAI/ARIA/apg/patterns/link/</a>)</Typography>
<ul>
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Keyboard accessibility</Typography>
<ul>
...
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Screen reader accessibility</Typography>
<ul>
