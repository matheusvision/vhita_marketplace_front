import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Rating</Typography>
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Basic rating</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Rating precision</Typography>
<Typography className="mb-40" component="div">The rating can display any float number with the <code>{`value`}</code> prop.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Hover feedback</Typography>
<Typography className="mb-40" component="div">You can display a label on hover to help the user pick the correct rating value.
...
<Typography className="mb-40" component="div">For larger or smaller ratings use the <code>{`size`}</code> prop.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    name="RatingSize.js"
                    className="my-24"
                    iframe={false}
...
<Typography className="mb-40" component="div">The rating is implemented with a radio group, set <code>{`highlightSelectedOnly`}</code> to restore the natural behavior.</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="mb-40" component="div">(<a href="https://www.w3.org/WAI/tutorials/forms/custom-controls/#a-star-rating">WAI tutorial</a>)</Typography>
...
<Typography className="mb-40" component="div">The read only rating has a role of &quot;img&quot;, and an aria-label that describes the displayed rating.</Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Keyboard</Typography>
<Typography className="mb-40" component="div">Because the rating component uses radio buttons, keyboard interaction follows the native browser behavior. Tab will focus the current rating, and cursor keys control the selected rating.</Typography>
<Typography className="mb-40" component="div">The read only rating is not focusable.</Typography>
