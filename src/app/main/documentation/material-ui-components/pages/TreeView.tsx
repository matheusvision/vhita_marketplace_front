	...
	return (
		<>
			...
			<Typography
				...
				component="div"
			>
				Tree views can be used to represent a file system navigator displaying folders and files, an item
				representing a folder can be expanded to reveal the contents of the folder, which may be files, folders,
				or both.
			</Typography>
			<Typography
			...
			<Typography
				...
				component="div"
			>
				While the <code>TreeView</code>/<code>TreeItem</code> component API maximizes flexibility, an extra step
				is needed to handle a rich object.
			</Typography>
			<Typography
				className="text-14 mb-32"
				component="div"
...
`}
			...
			<Typography
				...
				component="div"
			>
				You can use the <code>ContentComponent</code> prop and the <code>useTreeItem</code> hook to further
			...
			>
				...
				reference or provide a label on the TreeView, otherwise screen readers will announce it as
				&quot;tree&quot;, making it hard to understand the context of a specific tree item.
			</Typography>
		</>
	);
}
