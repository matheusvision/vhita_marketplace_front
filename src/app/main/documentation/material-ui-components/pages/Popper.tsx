import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Popper</Typography>
...
<Typography className="mb-40" component="div">Some important features of the <code>{`Popper`}</code> component:</Typography>
<ul>
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Basic popper</Typography>
...
<Typography className="mb-40" component="div">The open/close state of the popper can be animated with a render prop child and a transition component.
...
<Typography className="mb-40" component="div">Popper has built-in support for <a href="https://github.com/reactjs/react-transition-group">react-transition-group</a>.</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Positioned popper</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Scroll playground</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="mb-40" component="div">The value of the <code>{`anchorEl`}</code> prop can be a reference to a fake DOM element.
...
<Typography className="mb-40" component="div">Highlight part of the text to see the popper:</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="mb-40" component="div">The package <a href="https://github.com/jcoreio/material-ui-popup-state"><code>{`material-ui-popup-state`}</code></a> that takes care of popper state for you in most cases.</Typography>
<Typography className="mb-40" component="div"><FuseExample
