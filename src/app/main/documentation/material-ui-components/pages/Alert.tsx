		...
		<>
			...
			<div className="border border-1 p-16 rounded-16 my-12">
				...
				>
					...
					<a href="https://m2.material.io/">Material Design guidelines</a>, but it is available in Material
					UI.
				</Typography>
			</div>
			...
			<Typography
				...
				component="div"
			>
				An alert can have an action, such as a close or undo button. It is rendered after the message, at the
				end of the alert.
			</Typography>
			<Typography
				className="text-14 mb-32"
			...
			>
				...
				displayed. The <code>action</code> prop can be used to provide an alternative action, for example using
			...
			<Typography
				...
				component="div"
			>
				You can use a <a href="/material-ui/transitions/">transition component</a> such as <code>Collapse</code>{' '}
			...
			<Typography
				...
				component="div"
			>
				The <code>icon</code> prop allows you to add an icon to the beginning of the alert component. This will
				override the default icon for the specified severity.
			</Typography>
			<Typography
				className="text-14 mb-32"
				component="div"
			>
				You can change the default severity to icon mapping with the <code>iconMapping</code> prop. This can be
				defined globally using{' '}
				<a href="/material-ui/customization/theme-components/#theme-default-props">theme customization</a>.
			</Typography>
			<Typography
				className="text-14 mb-32"
				component="div"
			...
			>
				...
				, background content will be visible and bleed through the alert by default. You can prevent this by
				adding <code>{`bgcolor: 'background.paper'`}</code> to the
			...
			<Typography
				...
				component="div"
			>
				You can use the Snackbar to <a href="/material-ui/react-snackbar/#customization">display a toast</a>{' '}
				with the Alert.
			</Typography>
			<Typography
				className="text-24 mt-24 mb-10 font-700"
			...
			<Typography
				...
				component="div"
			>
				When the component is dynamically displayed, the content is automatically announced by most screen
				readers. At this time, screen readers do not inform users of alerts that are present when the page
				loads.
			</Typography>
			<Typography
				className="text-14 mb-32"
			...
			>
				...
				obvious from the content itself (for example the visible text), or is included through alternative
