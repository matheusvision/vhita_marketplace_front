import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Grid version 2</Typography>
...
<Typography className="mb-40" component="div">The <code>{`Grid`}</code> component works well for a layout with a known number of columns.
The columns can be configured with multiple breakpoints to specify the column span of each child.</Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">What&#39;s changed</Typography>
<Typography className="mb-40" component="div">We built the <code>{`Grid`}</code> component from scratch in order to:</Typography>
<ul>
...
<Typography className="mb-40" component="div">Since the new implementation is considered a breaking change, we introduced it as <code>{`Unstable_Grid2`}</code> to gather feedbacks from the community before making it stable in the next major release of Material UI.</Typography>
<Typography className="mb-40" component="div">We encourage everyone to try the new version of the <code>{`Grid`}</code> by visiting the <a href="/material-ui/migration/migration-grid-v2/">Grid v2 migration guide</a>.</Typography>
<Typography className="mb-40" component="div">:::info
From now on, the <code>{`Grid`}</code> v1 and <code>{`Grid`}</code> v2 refer to the import as:</Typography>
...
<Typography className="mb-40" component="div">:::</Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">How it works</Typography>
<Typography className="mb-40" component="div">The grid system is implemented with the <code>{`Grid`}</code> component:</Typography>
<ul>
...
:::</Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Fluid grids</Typography>
<Typography className="mb-40" component="div">Fluid grids use columns that scale and resize content. A fluid grid&#39;s layout can use breakpoints to determine if the layout needs to change dramatically.</Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Basic grid</Typography>
<Typography className="mb-40" component="div">In order to create a grid layout, you need a container.
...
<Typography className="mb-40" component="div">Column widths are integer values between 1 and 12.
They can be applied at any breakpoint to indicate how many columns are occupied by the component.</Typography>
<Typography className="mb-40" component="div">A value given to a breakpoint applies to all the other wider breakpoints unless overridden—see <a href="#multiple-breakpoints">Multiple breakpoints</a> for details.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Multiple breakpoints</Typography>
<Typography className="mb-40" component="div">Components may have multiple widths defined, causing the layout to change at the defined breakpoint. Width values given to larger breakpoints override those given to smaller breakpoints.</Typography>
<Typography className="mb-40" component="div">For example, a component with <code>{`xs={12} sm={6}`}</code> occupies the entire viewport width when the viewport is <a href="/material-ui/customization/breakpoints/#default-breakpoints">less than 600 pixels wide</a>.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Spacing</Typography>
<Typography className="mb-40" component="div">Use the <code>{`spacing`}</code> prop to control the space between children.
...
<Typography className="mb-40" component="div">The following demo illustrates the use of the <code>{`spacing`}</code> prop:</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    name="SpacingGrid.js"
                    className="my-24"
                    iframe={false}
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Row and column spacing</Typography>
<Typography className="mb-40" component="div">The <code>{`rowSpacing`}</code> and <code>{`columnSpacing`}</code> props let you specify row and column gaps independently of one another.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Responsive values</Typography>
<Typography className="mb-40" component="div">You can set prop values to change when a given breakpoint is active.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="mb-40" component="div">Responsive values are supported by:</Typography>
<ul>
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Auto-layout</Typography>
<Typography className="mb-40" component="div">The auto-layout feature gives equal space to all items present.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Variable width content</Typography>
<Typography className="mb-40" component="div">When a breakpoint&#39;s value is given as <code>{`"auto"`}</code> instead of <code>{`true`}</code> or a number, then a column&#39;s size will automatically adjust to match the width of its content.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Nested grid</Typography>
<Typography className="mb-40" component="div">The grid container that renders as a <strong>direct child</strong> inside another grid container is a nested grid that inherits its <a href="#columns"><code>{`columns`}</code></a> and <a href="#spacing"><code>{`spacing`}</code></a> from the top level.
It will also inherit the props of the top-level grid if it receives those props.</Typography>
<Typography className="mb-40" component="div">:::success</Typography>
<Typography className="mb-40" component="div">Note that a nested grid container should be a direct child of another grid container. If there are non-grid elements in between, the grid container will start as the new root container.</Typography>
...
<Typography className="mb-40" component="div">:::</Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Inheriting spacing</Typography>
<Typography className="mb-40" component="div">A nested grid container will inherits the row and column spacing from its parent unless the <code>{`spacing`}</code> prop is specified to the instance.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    name="NestedGrid.js"
                    className="my-24"
                    iframe={false}
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Inheriting columns</Typography>
<Typography className="mb-40" component="div">A nested grid container will inherits the columns from its parent unless the <code>{`columns`}</code> prop is specified to the instance.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Columns</Typography>
<Typography className="mb-40" component="div">Use the <code>{`columns`}</code> prop to change the default number of columns (12) in the grid, as shown below:</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    name="ColumnsGrid.js"
                    className="my-24"
                    iframe={false}
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Offset</Typography>
<Typography className="mb-40" component="div">Offset props (such as <code>{`smOffset`}</code>, <code>{`mdOffset`}</code>) push an item to the right side of the grid.
...
<Typography className="mb-40" component="div">The demo below illustrates how to use the offset props:</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    name="OffsetGrid.js"
                    className="my-24"
                    iframe={false}
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Custom breakpoints</Typography>
<Typography className="mb-40" component="div">If you specify custom breakpoints in the theme, you can use those names as grid item props in responsive values:</Typography>
...
<Typography className="mb-40" component="div">:::info
Custom breakpoints affect both size and offset props:</Typography>
...
<Typography className="mb-40" component="div">:::</Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">TypeScript</Typography>
<Typography className="mb-40" component="div">You have to set module augmentation on the theme breakpoints interface.
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Disable the scrollbar</Typography>
<Typography className="mb-40" component="div">If you use grid as a container in a small viewport, you might see a horizontal scrollbar because the negative margin is applied on all sides of the grid container.</Typography>
<Typography className="mb-40" component="div">To disable this scrollbar, set the <code>{`disableEqualOverflow`}</code> prop to <code>{`true`}</code>.
This removes the negative margins from the bottom and right sides of the grid to prevent overflow.</Typography>
<Typography className="mb-40" component="div">The demo below shows how this works:</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Centered elements</Typography>
<Typography className="mb-40" component="div">To center a grid item&#39;s content, specify <code>{`display="flex"`}</code> directly on the item.
...
:::</Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Full border</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Half border</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Column direction and reversing</Typography>
<Typography className="mb-40" component="div">The column width (<code>{`xs`}</code>, ..., <code>{`xl`}</code>) and offset props are <em>not</em> supported within containers that use <code>{`direction="column"`}</code> or <code>{`direction="column-reverse"`}</code>.</Typography>
<Typography className="mb-40" component="div">Size and offset props define the number of columns the component will use for a given breakpoint.
