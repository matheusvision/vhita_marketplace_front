	...
	return (
		<>
			...
			>
				...
				<a href="https://m2.material.io/design/typography/#type-scale">typographic scale</a> has a limited set
				of type sizes that work well together along with the layout grid.
			</Typography>
			<Typography
			...
			<Typography
				...
				component="div"
			>
				The <em>Roboto</em> font will <strong>not</strong> be automatically loaded by Material UI. You are
				responsible for loading any fonts used in your application. Roboto Font has a few easy ways to get
				started. For more advanced configuration, check out
...
`}
			...
			<Typography
				...
				component="div"
			>
				Fontsource can be configured to load specific subsets, weights and styles. Material UI default
			...
			<Typography
				...
				component="div"
			>
				The Typography component makes it easy to apply a default set of font weights and sizes in your
				application.
			</Typography>
			<Typography
				className="text-14 mb-32"
			...
			<Typography
				...
				component="div"
			>
				In some situations you might not be able to use the <code>Typography</code> component. Hopefully, you
...
`}
			...
			<ul className="space-y-16">
				...
				<li>
					...
					<a href="/material-ui/customization/typography/#font-size">relative units (rem)</a> to accommodate
					the user&#39;s settings.
				</li>
				<li>
					<strong>Heading hierarchy</strong>.{' '}
					<a href="https://www.w3.org/WAI/tutorials/page-structure/headings/">Don&#39;t skip</a> heading
					levels. In order to solve this problem, you need to{' '}
