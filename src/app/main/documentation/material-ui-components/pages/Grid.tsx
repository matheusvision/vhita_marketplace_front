	...
	return (
		<>
			...
			<Typography
				...
				component="div"
			>
				A value given to a breakpoint applies to all the other breakpoints wider than it (unless overridden, as
				you can read later in this page). For example, <code>{`xs={12}`}</code> sizes a component to occupy the
				whole viewport width regardless of its size.
			</Typography>
			<Typography
				className="text-14 mb-32"
				component="div"
