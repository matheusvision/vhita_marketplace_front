import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Masonry</Typography>
...
<Typography className="mb-40" component="div">Masonry maintains a list of content blocks with a consistent width but different height.
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Basic masonry</Typography>
<Typography className="mb-40" component="div">A simple example of a <code>{`Masonry`}</code>. <code>{`Masonry`}</code> is a container for one or more items. It can receive any element including <code>{`<div />`}</code> and <code>{`<img />`}</code>.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Image masonry</Typography>
<Typography className="mb-40" component="div">This example demonstrates the use of <code>{`Masonry`}</code> for images. <code>{`Masonry`}</code> orders its children by row.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Items with variable height</Typography>
<Typography className="mb-40" component="div">This example demonstrates the use of <code>{`Masonry`}</code> for items with variable height.
...
<Typography className="mb-40" component="div">This example demonstrates the use of the <code>{`columns`}</code> to configure the number of columns of a <code>{`Masonry`}</code>.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="mb-40" component="div"><code>{`columns`}</code> accepts responsive values:</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="mb-40" component="div">This example demonstrates the use of the <code>{`spacing`}</code> to configure the spacing between items.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="mb-40" component="div"><code>{`spacing`}</code> accepts responsive values:</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Server-side rendering</Typography>
<Typography className="mb-40" component="div">This example demonstrates the use of the <code>{`defaultHeight`}</code>, <code>{`defaultColumns`}</code> and <code>{`defaultSpacing`}</code>, which are used to
support server-side rendering.</Typography>
<Typography className="mb-40" component="div">:::info
<code>{`defaultHeight`}</code> should be large enough to render all rows. Also, it is worth mentioning that items are not added to the shortest column in case of server-side rendering.
:::</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    name="SSRMasonry.js"
                    className="my-24"
