			...
			<ul className="space-y-16">
				...
				<li>
					...
					>
						...
						component. In this case, you can apply the additional attribute (e.g. <code>aria-label</code>,{' '}
						<code>aria-labelledby</code>, <code>title</code>) via the <code>inputProps</code> property.
					</Typography>
				</li>
			</ul>
