import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Progress</Typography>
...
<Typography className="mb-40" component="div">Progress indicators inform users about the status of ongoing processes, such as loading an app, submitting a form, or saving updates.</Typography>
<ul>
...
<Typography className="mb-40" component="div">The animations of the components rely on CSS as much as possible to work even before the JavaScript is loaded.</Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Circular</Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Circular indeterminate</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Circular color</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Circular determinate</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Interactive integration</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Circular with label</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Linear</Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Linear indeterminate</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Linear color</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    name="LinearColor.js"
                    className="my-24"
                    iframe={false}
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Linear determinate</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Linear buffer</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">Linear with label</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Non-standard ranges</Typography>
<Typography className="mb-40" component="div">The progress components accept a value in the range 0 - 100. This simplifies things for screen-reader users, where these are the default min / max values. Sometimes, however, you might be working with a data source where the values fall outside this range. Here&#39;s how you can easily transform a value in any range to a scale of 0 - 100:</Typography>
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Delaying appearance</Typography>
<Typography className="mb-40" component="div">There are <a href="https://www.nngroup.com/articles/response-times-3-important-limits/">3 important limits</a> to know around response time.
...
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">High CPU load</Typography>
<Typography className="mb-40" component="div">Under heavy load, you might lose the stroke dash animation or see random <code>{`CircularProgress`}</code> ring widths.
...
<Typography className="mb-40" component="div"> src="/material-ui-static/images/progress/heavy-load.gif" alt="heavy load/></Typography>
<Typography className="mb-40" component="div">When it&#39;s not possible, you can leverage the <code>{`disableShrink`}</code> prop to mitigate the issue.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-20 mt-20 mb-10 font-700" component="h3">High frequency updates</Typography>
<Typography className="mb-40" component="div">The <code>{`LinearProgress`}</code> uses a transition on the CSS transform property to provide a smooth update between different values.
...
<Typography className="mb-40" component="div">If you need to perform 30 re-renders per second or more, we recommend disabling the transition:</Typography>
...
<Typography className="mb-40" component="div">The circular progress component animation on IE 11 is degraded.
