	...
	return (
		<>
			...
			<Typography
				...
				component="div"
			>
				The divider renders as an <code>{`<hr>`}</code> by default. You can save rendering this DOM element by
				using the <code>divider</code> prop on the <code>ListItem</code> component.
			</Typography>
			<Typography
				className="text-14 mb-32"
				component="div"
			...
			<Typography
				...
				component="div"
			>
				In a list, you should ensure the <code>Divider</code> is rendered as an <code>{`<li>`}</code> to match
				the HTML5 specification. The examples below show two ways of achieving this.
			</Typography>
			<Typography
				className="text-24 mt-24 mb-10 font-700"
				component="h2"
			...
			<Typography
				...
				component="div"
			>
				:::warning When using the <code>Divider</code> component for visual decoration, such as in a heading,
				explicitly specify <code>{`role="presentation"`}</code> to the divider to make sure screen readers can
