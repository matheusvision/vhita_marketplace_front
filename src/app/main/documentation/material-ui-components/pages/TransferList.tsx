import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Transfer List</Typography>
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Basic transfer list</Typography>
<Typography className="mb-40" component="div">For completeness, this example includes buttons for &quot;move all&quot;, but not every transfer list needs these.</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Enhanced transfer list</Typography>
<Typography className="mb-40" component="div">This example exchanges the &quot;move all&quot; buttons for a &quot;select all / select none&quot; checkbox, and adds a counter.</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="mb-40" component="div">The component comes with a couple of limitations:</Typography>
<ul>
