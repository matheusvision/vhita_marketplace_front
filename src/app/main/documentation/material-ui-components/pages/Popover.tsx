import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 grow-0 items-center justify-end">
                     ...
                     <Typography className="text-40 my-16 font-700" component="h1">Popover</Typography>
<Typography className="description">A Popover can be used to display some content on top of another.</Typography>

<Typography className="mb-40" component="div">Things to know when using the <code>{`Popover`}</code> component:</Typography>
<ul>
...
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Basic Popover</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Anchor playground</Typography>
<Typography className="mb-40" component="div">Use the radio buttons to adjust the <code>{`anchorOrigin`}</code> and <code>{`transformOrigin`}</code> positions.
...
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-32 mt-40 mb-10 font-700" component="h2">Mouse over interaction</Typography>
<Typography className="mb-40" component="div">This demo demonstrates how to use the <code>{`Popover`}</code> component and the mouseover event to achieve popover behavior.</Typography>
<Typography className="mb-40" component="div"><FuseExample
...
<Typography className="mb-40" component="div">Highlight part of the text to see the popover:</Typography>
<Typography className="mb-40" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="mb-40" component="div">For more information on the virtual element&#39;s properties, see the following resources:</Typography>
<ul>
...
<Typography className="mb-40" component="div">The package <a href="https://github.com/jcoreio/material-ui-popup-state"><code>{`material-ui-popup-state`}</code></a> that takes care of popover state for you in most cases.</Typography>
<Typography className="mb-40" component="div"><FuseExample
