...
function ChatPanel(props: any) {
	...
	const handlers = useSwipeable({
		onSwipedLeft: () => state && theme.direction === 'rtl' && dispatch(closeChatPanel()),
		onSwipedRight: () => state && theme.direction === 'ltr' && dispatch(closeChatPanel())
	});
	 ...
	 */
	useEffect(() => {
		function handleDocumentClick(ev: any) {
