...
import i18Raw from 'src/@i18n/i18n.ts?raw';
import enLangRaw from '@/app/(control-panel)/apps/mailbox/i18n/en.ts?raw';
import appConfigRaw from '@/app/(control-panel)/apps/mailbox/MailboxAppRoute.tsx?raw';
	...
	return (
		<>
			...
			>
				...
				<code>@/app/(control-panel)/apps/mailbox/MailboxAppConfig.tsx</code>
			</Typography>
			...
			>
				...
				<code>src/components/theme-layouts/components/LanguageSwitcher.tsx</code>
			</Typography>
		</>
	);
}
